        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            if(infCas != null && selected){
                ...
                Vector2 dist =   infCas.getCords() -
                    ...
                    if(infGeneral.getMovement() >= Mathf.Abs(dist.x) &&
                    infGeneral.getMovement() >= Mathf.Abs(dist.y)){
                        ...
                        GameManager.instance.setFicha((int)infCas.getCords().y, (int)infCas.getCords().x, hit.transform.gameObject);
